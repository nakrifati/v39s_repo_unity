...
public class TargetMover : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        cam = Camera.main;
        target = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerController>().particle.transform;
    }
    ...
    void Update()
    {
        ...
        //    UpdateTargetPosition();
        //}
        target.position = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerController>().particleClone.transform.position;
    }
